...
return [
    ...
    */
    ...
    'authorize_device_text' => 'You are logging from a device or location we haven\'t seen before or for some time. Please authorize your device from mail that we sent you',
